...
async def invite():
  	...
  	await bot.whisper("Add me with this link {}".format(discord.utils.oauth_url(467728819835371540)))
    ...
    if reaction.me == True:
        if user.id != '495319988056489986':
            if reaction.emoji == '\U00002705':
                ...
                embed.add_field(name='3. $info @user/$serverinfo', value='------------', inline=False)
...
bot.run("NDY3NzI4ODE5ODM1MzcxNTQw.Dpm0UA.ra2cW0JhwUB1pIl07iKQBBV1INI")
